...
extension UIView {
    ...
    var saveTopAnchor: NSLayoutYAxisAnchor {
    ...
    var saveLeftAnchor: NSLayoutXAxisAnchor {
        if #available(iOS 11.0, *) {
    ...
    var saveBottomAnchor: NSLayoutYAxisAnchor {
        if #available(iOS 11.0, *) {
            return safeAreaLayoutGuide.bottomAnchor
        }
        return bottomAnchor
    }
    var saveRightAnchor: NSLayoutXAxisAnchor {
        if #available(iOS 11.0, *) {
